export function createPromptCodeExplain(
  language: string,
  functionCode: string,
): string {
...
export function createPromptCodeClean(
  language: string,
  functionCode: string,
): string {
...
export function createPromptGenerateComment(
  language: string,
  functionCode: string,
): string {
...
export function createPromptGenerateUnitTest(
  language: string,
  functionCode: string,
): string {
...
export function createPromptCheckPerformance(
  language: string,
  functionCode: string,
): string {
...
export function createPromptCheckSecurity(
  language: string,
  functionCode: string,
): string {
